...
const LOGO_ICON = '/essixx-logo.png'
...
const PILLARS = [
  {
    label: 'Discover',
    items: ['workshops', 'research', 'scope', 'timelines'],
    leftVw: 2.8,
    bottomVw: 7,
  },
  {
    label: 'Design',
    items: ['UI / UX', 'prototype', 'review', 'iterate'],
    leftVw: 22.4,
    bottomVw: 9.08,
  },
  {
    label: 'Build',
    items: ['develop', 'test', 'CI', 'ship'],
    leftVw: 41.2,
    bottomVw: 11.16,
  },
  {
    label: 'Launch',
    items: ['deploy', 'measure', 'support', 'grow'],
    leftVw: 61.1,
    bottomVw: 13.24,
  },
]
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span className="ps-line-nowrap" style={{ display: 'block' }}>
              Freelance quality.
            </span>
            <span
              style={{
          ...
          >
            Essixx teams discover, design, build and launch exactly what keeps your
            product on track — from ₹19,999 only.
          </p>
        </div>
      </div>
